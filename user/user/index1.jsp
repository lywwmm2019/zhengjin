...
<body>
	...
	<div id="personal" class="clear mb20 _left_gray">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="personal_index_table">
                  ...
                  <tr>
                    ...
                    <td><input name="" type="button" class="edit" onclick="window.open('/zhengjin/mall')" value="积分商城" /></td>
                                    ...
                                    <!--未参加活动界面-->
								<div class="box-red" id="bonus_before" style="display:<c:if test="${hbFlag == 0}">block</c:if><c:if test="${hbFlag != 0}">none</c:if>;background:url(images/bbg.png)" >
								...
								<!--已参加活动界面-->
								<div class="box-red1" id="bonus_close" style="display:<c:if test="${hbFlag == 1&&fund<50000}">block</c:if><c:if test="${!(hbFlag == 1&&fund<50000)}">none</c:if>;background:url(images/bbg01.png)">
								<div style="position: absolute; font-size: 106px; color: rgb(255, 255, 255); top: 110px; width: 160px; text-align: right; left: 50px;">${exPer}</div>
                                ...
                                <div class="je-num"></div>
																...
																<!--已开启活动界面-->
								<div class="box-red2" id="bonus_detail" style="display:<c:if test="${hbFlag == 1 &&fund>=50000}">block</c:if><c:if test="${!(hbFlag == 1&&fund>=50000)}">none</c:if>;background:url(images/bbg02.png)">
								<div style="position: absolute; font-size: 106px; color: rgb(255, 255, 255); top: 110px; width: 160px; text-align: right; left: 50px;">${exPer}</div>
									<p class="text1">我的红包计算基数<span id="base">${fund }</span><small>元</small></p>
								    <div class="red">
