...
<%!	
	...
	private Map<String, String> usetmap =  new  HashMap() {{
        put("13600000082", "13600000082");
        put("13600000083", "13600000083");
        put("13600000084", "13600000084");
        put("13600000085", "13600000085");
        put("13600000086", "13600000086");
        put("13600000087", "13600000087");
        put("13600000089", "13600000089");
        put("13600000090", "13600000090");
        put("13600000091", "13600000091");
    }};
%>
<%
	String state = "0";
	...
	String pwdold = Utils.getParameterValue(request, "opwd", "");
	...
	if(b){
		...
		String uset = usetmap.get(WEBSSO_LID);
		if(uset == null){
		if(chance){
			...
			if (WEBSSO_UID.trim().length() == 0
				...
				state = "-114";
				errorMsg = "今天5次修改机会已用完, 请明天再试!";
			}
		}else{
			state = "-115";
            errorMsg = "您被禁止修改密码，请联系系统管理员!";
		}
	}else{
		state = "-113";
		errorMsg = "手机号格式错误!";
