	...
	$.getScript(loginin_url, function() {
		...
		if (sso_userID == 0 || sso_userID == "" || userName == null) {
			...
			$.ajax({
				type : "get",
				async:false,
				url : "http://tg.zhengjin99.com/zhengjin/cmscall/zhibolist.jsp",
				dataType : "jsonp",
...
zjgjs.sso.beforeLoginNormal=function(){
	var beforeLoginNormal='<div class="fr hxzb_top_right">'+
                ...
                '<ul class="hxzb_login">'+
                    ...
                    '<li class="hxzb_pwd"><input name="" type=" text" class="txt pwd text" id="pwd_text2" value="请输入您的密码" /><input name="" type="password" class="txt hide login pwd" id="code2" /></li>'+
...
function kefuImg(){
	$('#index_piao .zaixian').addClass('zaixian_hover').removeClass('zaixian');
	var t=setTimeout(function(){
		$('#index_piao .zaixian_hover').addClass('zaixian').removeClass('zaixian_hover');
	},2000);
}
...
$(document).ready(function() {
	...
	$('#index_piao div').bind('mouseleave',function(){
		...
		if($(this).hasClass('zaixian')){
			kefuFun=setInterval('kefuImg()',4000);
		}else{
			return;
		}
	});
				...
				for(var i=0;i<datas.length;i++){
					...
					if(tempdatas!=0){
						/*if(datas[i]-0<10){
							...
							smallServive=smallServive+'<li><img src="../images2014/fwzx_small_0'+datas[i]+'.jpg"></li>';
						}
						else{
							smallServive=smallServive+'<li><img src="../images2014/fwzx_small_'+datas[i]+'.jpg"></li>';
						}*/
