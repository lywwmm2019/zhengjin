...
Incremental.prototype = {
	...
	isThere:function(code,type){

		for(var i=0;i<this[type].length;i++){
			if(this[type][i]["code"] == code){
				return this[type][i];
			}
		}
...
Price.prototype={
	 ...
	 KChart:function(num,index){
		...
		//增量代码
		var kObj = this.Incremental.isThere(num,"K");
		...
		if(num==399001){
			...
			var KUrl="http://bjgjshq.zhengjin99.com/mongooper/cmdh5.jsp?pattern=4&code="+num+"&type=1&date="+kObj.date+"&time="+kObj.time+"&offset=";
		}
		...
		$.getScript(KUrl, function() {
			try{
				if(num==000001||num==399001){
					...
					if(kObj.date == ""){
						kObj.data = b;
						kObj.time = b.d.d[b.d.d.length-1].t;
						kObj.date = b.d.d[b.d.d.length-1].d;
					} else {
						if(b.d.d.length>1){
							b.d.d.splice(0,1);
							kObj.data.d.d = kObj.data.d.d.concat(b.d.d);
							kObj.time = b.d.d[b.d.d.length-1].t;
							kObj.date = b.d.d[b.d.d.length-1].d;
						}
					}
	...
	MinuteChart:function(num,index){
		...
		//增量代码
		var fObj = this.Incremental.isThere(num,"F");
		...
		if(num==399001){
			...
			var MinuteUrl="http://bjgjshq.zhengjin99.com/mongooper/cmdh5.jsp?pattern=3&code="+num+"&date="+fObj.date+"&time="+fObj.time+"&offset=";
		}
		...
		$.getScript(MinuteUrl, function() {
			...
			try{
				if(num==000001||num==399001){
					...
					if(fObj.date == ""){
						fObj.data = b;
						fObj.time = b.d[0].d[b.d[0].d.length-1].t;
						fObj.date = b.d[0].d[b.d[0].d.length-1].d;
					} else {
						if(b.d[0].d.length>1){
							b.d[0].d.splice(0,1);
							fObj.data.d[0].d = fObj.data.d[0].d.concat(b.d[0].d);
							fObj.time = b.d[0].d[b.d[0].d.length-1].t;
							fObj.date = b.d[0].d[b.d[0].d.length-1].d;
						}
					}
