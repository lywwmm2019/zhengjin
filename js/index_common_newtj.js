...
zjgjs.sso.beforeLoginHtml = function() {
	var html = '<div class="fr">手机号<input id="passport" name="" type="text" class="input_txt" />密码<input id="password" onkeypress="BindEnter(event)" name="" type="password" class="input_txt" /><input name="" type="button" class="input_zcbtn" value="登陆"  onclick="zjgjs.sso.login(\'\')" /><input type="button" class="input_loginbtn" value="注册" onclick="window.open(\'http://tg.zhengjin99.com/zhengjin/sign_up.jsp\')" /><a href="http://tg.zhengjin99.com/zhengjin/find_password.jsp" class="find_pwd">找回密码</a></div><div class="clear"></div>';
	return html;
};
zjgjs.sso.afterLoginHtml = function() {
	...
	var html = '<span class="mr5">'+userPhone+'</span>您好，欢迎回来！<input class="input_zcbtn ml5" type="button" value="退出" name=""><a href="findpwd.html" class="find_pwd">找回密码</a>';
	return html;
};
...
zjgjs.sso.init = function() {
	...
	sso_userID = getCookie("WEBSSO_UID");
